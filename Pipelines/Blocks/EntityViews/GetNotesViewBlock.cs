...
using Sitecore.Commerce.Plugin.ExtendCatalog.Extensions;
        ...
        private void AddPropertiesToView(EntityView entityView, NotesComponents component, bool isReadOnly)
        {
            entityView.Properties.Add(
               new ViewProperty
               {
                   ...
                   DisplayName= component.GetDisplayName(nameof(component.WarrantyInformation)),
            ...
            entityView.Properties.Add(
                new ViewProperty
                {
                    ...
                    DisplayName = component.GetDisplayName(nameof(component.InternalNotes)),
